...
export const footerMocks = {
  ...
  centralBranch: {
    title: ['Merkez Şube', 'Central Branch'],
    address: [
  ...
  socialMedia: {
    links: [
      {
        name: 'facebook',
        url: 'https://www.facebook.com/people/Uluda%C4%9Flar-Gayrimenkul/100069383305192/#',
      },
      {
        name: 'instagram',
        url: 'https://www.instagram.com/uludaglargayrimenkul/',
      },
      {
        name: 'youtube',
        url: 'https://www.youtube.com/user/uludaglargayrimenkul',
      },
      {
        name: 'linkedin',
        url: 'https://tr.linkedin.com/in/mustafa-uluda%C4%9F-2231843a',
      },
    ],
  },
};